...
export class Search extends React.Component {
  ...
  // if( this.state.userLocation.lon == this.state.lon +(0.2) || this.state.userLocation.lon == this.state.lon ||this.state.userLocation.lon == this.state.lon -(0.2)){
        this.setState({
...
<Card.Title><Alert >
  ...
  <hr />
  <Map style={{ width: '46rem',height:'22rem'  ,marginLeft:'-112' }}
        className={'map'}
...
<button style={{marginTop:'-191px', marginLeft:'344px'}} onClick={this.handleClick}  id='h' className=" wbtn tooltipped pulse waves-effect waves-light btn modal-trigger green lighten-4 black-text"> اقترح اخر
  {loading && <span>
